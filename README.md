# Paytm-AI-Clone
A pixel-perfect Paytm clone featuring an embedded accessibility-first AI companion.
...
Extract the project directory to your local workstation.
Locate the index.html file inside the root partition.
Simply execute (double-click) the file to launch it directly within Google Chrome, Microsoft Edge, or Safari.
Interact with the bot via text or utilize the microphone icon to test the seamless voice-to-text algorithms!
